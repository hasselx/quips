// Kill-switch worker: evicts the previous app service worker and its caches.
// Cache Storage is origin-scoped; only delete this registration's own Workbox caches.
function isWorkboxCacheForThisRegistration(name) {
  const hasWorkboxBucket = /(^|-)precache-v\d+-|(^|-)runtime-|(^|-)page-navigation|(^|-)hashed-assets|(^|-)googleAnalytics-/.test(name);
