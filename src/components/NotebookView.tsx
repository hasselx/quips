  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <Dialog open={parsedDialogOpen} onOpenChange={setParsedDialogOpen}>
        <DialogContent className="sm:max-w-md rounded-2xl max-h-[85vh] flex flex-col p-0 gap-0">
          ...
          {parsedExpense && (
            <>
              ...
              <div className="shrink-0 border-t border-border p-4 grid grid-cols-3 gap-2">
                <Button type="button" variant="ghost" className="rounded-xl h-11" onClick={() => setParsedDialogOpen(false)} disabled={receiptBusy}>
                  Cancel
                </Button>
                <Button type="button" variant="outline" className="rounded-xl h-11 gap-1.5" onClick={handleEditParsedExpense} disabled={receiptBusy}>
                  <Pencil className="h-4 w-4" />
                  Edit
                </Button>
                <Button type="button" className="rounded-xl h-11 gap-1.5" onClick={handleAddParsedExpense} disabled={receiptBusy}>
